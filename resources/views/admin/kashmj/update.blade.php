...
<div class="container">
    <div class="row justify-content-center">
        ...
        @endif
            <div class="card">
                <div class="card-header text-center">{{__('Update Kas HMJ') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('admin-kas-hmj.update', $showById->id ) }}">
                        @csrf
                        @method('PUT')
                        ...
                        @endif
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" autocomplete="off" class="form-control inst_amount" value="{{ $showById->total_kas_hmj }}" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="total_price" class="form-control total_amount" type="number" name="total_kas_hmj" value="{{ $showById->total_kas_hmj }}" readonly>
                            </div>
                        </div>
