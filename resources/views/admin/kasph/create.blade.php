...
<div class="container">
    <div class="row justify-content-center">
        ...
        @endif
            <div class="card">
            <div class="card-header text-center">{{__('Buat Data Iuran Kas Ph') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('admin-kas-ph.store') }}">
                        @csrf
                        ...
                        @endif
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="iuran_ph" type="number" class="form-control @error('iuran_ph') is-invalid @enderror" name="iuran_ph" required autocomplete="iuran_ph" autofocus>
                                @error('iuran_ph')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="denda_ph" type="number" class="form-control @error('denda_ph') is-invalid @enderror" name="denda_ph" required autocomplete="denda_ph" autofocus>
                                @error('denda_ph')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_batas_iuran" type="date" class="form-control @error('tanggal_batas_iuran') is-invalid @enderror" name="tanggal_batas_iuran" required autocomplete="tanggal_batas_iuran" autofocus>
